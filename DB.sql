...
--
-- Servidor: localhost
-- Tempo de Geração: Fev 21, 2014 as 08:21 PM
...
INSERT INTO `fisica` (`cpf`, `nome`, `codigo`, `sexo`, `nascimento`) VALUES
('080,084,144-13', 'pedro felipe', 18, 'Masculino', '0000-00-00');
...
INSERT INTO `juridica` (`cnpj`, `nome_fantasia`, `razao_social`, `codigo`, `responsavel`) VALUES
('748,209,708/9709-87', 'hljsfhl', 'jhdsalfhjklsh', 30, 'pedro');
...
(18, '(81)8888-8888', '(81)9273-7317', 'fellypeavelino@hotmail.com', 'Pernambuco', '88888-888', 'jabotao dos ', '', '20', 'nirvana'),
(30, '(81)9273-7317', '(88)8888-8888', 'felipeavel@gmil.com', 'Acre', '69869-869', 'hfsdajklshl', 'lj,hflhskl', '20', 'nirvana');
